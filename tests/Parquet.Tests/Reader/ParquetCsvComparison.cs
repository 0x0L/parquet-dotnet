...
namespace Parquet.Tests.Reader
{
    public class ParquetCsvComparison : TestBase
    {
        ...
        void Compare(DataSet parquet, DataSet csv, Type[] columnTypes)
        {
        ...
        void Compare(Schema schema, Row pc, Row cc)
        {
        ...
        object ChangeType(object v, Type t)
        {
        ...
        DataSet ReadParquet(string name)
        {
