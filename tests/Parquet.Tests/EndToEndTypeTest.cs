...
namespace Parquet.Tests
{
    ...
    {
        static readonly Dictionary<string, (DataField field, object expectedValue)> _nameToData =
            new Dictionary<string, (DataField field, object expectedValue)>
            {
                ...
                ["numpy datetime"] = (new DateTimeDataField("numpyDateTime", DateTimeFormat.NumpyDateTime), new DateTimeOffset(DateTime.UtcNow.RoundToSecond())),
                ...
                ["nullable bool"] = (new DataField<bool?>("bool?"), true)
            };
