...
namespace Parquet.Data.Concrete
{
    class DecimalDataTypeHandler : BasicPrimitiveDataTypeHandler<decimal>
    {
        ...
        void ReadAsInt32(Thrift.SchemaElement tse, BinaryReader reader, IList result)
        {
        ...
        void WriteAsInt32(Thrift.SchemaElement tse, BinaryWriter writer, IList values)
        {
        ...
        void ReadAsInt64(Thrift.SchemaElement tse, BinaryReader reader, IList result)
        {
            decimal scaleFactor = (decimal)Math.Pow(10, -tse.Scale);
        ...
        void WriteAsInt64(Thrift.SchemaElement tse, BinaryWriter writer, IList values)
        {
            double scaleFactor = Math.Pow(10, tse.Scale);
        ...
        void ReadAsFixedLengthByteArray(Thrift.SchemaElement tse, BinaryReader reader, IList result)
        {
        ...
        void WriteAsFixedLengthByteArray(Thrift.SchemaElement tse, BinaryWriter writer, IList values)
        {
            foreach (decimal d in values)
            {
