...
namespace Parquet.File
{
    class ColumnarReader
    {
        ...
        readonly Thrift.ColumnChunk _thriftColumnChunk;
        readonly Thrift.SchemaElement _thriftSchemaElement;
        ...
        public IList Read(long offset, long count)
        {
            ...
            IList mergedValues = new ValueMerger(
               ...
               values,
               _dataTypeHandler,
               _thriftSchemaElement.IsNullable()
        ...
        void ReadColumn(BinaryReader reader, Thrift.Encoding encoding, long maxValues,
           out IList values,
        ...
        byte[] ReadRawBytes(Thrift.PageHeader ph, Stream inputStream)
        {
