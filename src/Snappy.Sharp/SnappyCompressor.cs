...
namespace Snappy.Sharp
{
    public class SnappyCompressor
    {
        ...
        static int EmitCopyLessThan64(byte[] output, int outputIndex, int offset, int length)
        {
        ...
        static int EmitCopy(byte[] compressed, int compressedIndex, int offset, int length)
        {
        ...
        static int FindMatchLengthBasic(byte[] s1, int s1Index, int s2Index, int s2Limit)
        {
        ...
        static int FindMatchLength32(byte[] s1, int s1Index, int s2Index, int s2Limit)
        {
            Debug.Assert(s2Limit >= s2Index);
        ...
        static int FindMatchLength64(byte[] s1, int s1Index, int s2Index, int s2Limit)
        {
            Debug.Assert(s2Limit >= s2Index);
        ...
        static uint Hash(uint bytes, int shift)
        {
